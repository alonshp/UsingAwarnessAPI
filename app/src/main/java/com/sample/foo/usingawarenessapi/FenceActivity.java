...
public class FenceActivity extends AppCompatActivity {
    ...
    public static final String HEADPHONE_FENCE_KEY = "your key here";
    public static final String HEADPHONE_AND_WALKING_FENCE_KEY = "your key here";
    public static final String HEADPHONE_OR_WALKING_FENCE_KEY = "your key here";
...
//        unregisterReceiver(mFenceReceiver);
    ...
    private void addHeadphoneAndLocationFence() {
        ...
        Awareness.FenceApi.updateFences(
                mGoogleApiClient,
                new FenceUpdateRequest.Builder()
                        .addFence(HEADPHONE_FENCE_KEY, activityFence, mFencePendingIntent)
                        .build())
                .setResultCallback(new ResultCallback<Status>() {
                    @Override
                    public void onResult(@NonNull Status status) {
